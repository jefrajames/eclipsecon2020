...
(brandname, businessactivity, contractstatus, joindate, city, country, number, street, scoreenabled, scoreid, servicelevel, website) 
values 
('Chez Marcel', 'RESTAURANT', 'ENABLED', '1979-12-12', 'New York City', 'USA', '5', 'Broadway', true, 'ms-1', 'PREMIUM', 'http://www.restaurantmarcel.fr/');
...
insert INTO merchant_contacts (merchant_id, emailaddresses, name, phonenumbers)
VALUES (1, 'mauricette@hotmail.com', 'Mauricette Dupont', '12-56-78-90-34');
insert INTO merchant_contacts (merchant_id, emailaddresses, name, phonenumbers)
VALUES (1, 'thomas@yahoo.com', 'Thomas Dupont', '16-52-78-90-34');
...
(brandname, businessactivity, contractstatus, joindate, city, country, number, street, scoreenabled, scoreid, servicelevel, website) 
values 
('Labbe Bookstore', 'BOOKSTORE', 'ENABLED', '2002-05-05', 'Blois', 'France', '2', 'rue Porte Chartraine', true, 'ms-2', 'STANDARD', 'https://librairie-labbe.business.site/');
...
(brandname, businessactivity, contractstatus, joindate, city, country, number, street, scoreenabled, scoreid, servicelevel, website) 
values 
('Chinese Theatre', 'THEATER', 'ENABLED', '2012-06-05', 'Los Angeles', 'USA', '2', 'Main Street', true, 'ms-3', 'PREMIUM', 'http://www.tclchinesetheatres.com/');
...
insert INTO merchant_contacts (merchant_id, emailaddresses, name, phonenumbers)
VALUES (3, 'jcvd@hotmail.com', 'JCVD', '37-56-08-90-12');
insert INTO merchant_contacts (merchant_id, emailaddresses, name, phonenumbers)
VALUES (3, 'chuckno@hotmail.com', 'Chuck Norris', '77-56-08-95-12');

-- Merchant 4
insert into merchant 
(brandname, businessactivity, contractstatus, joindate, city, country, number, street, scoreenabled, scoreid, servicelevel, website) 
values 
('Sport pour tous', 'SPORT', 'ENABLED', '2018-06-11', 'Montreal', 'Canada', '171', 'Bernard Ouest', true, 'ms-4', 'BASIC', 'http://www.sportpourtous.ca/');
...
insert INTO merchant_contacts (merchant_id, emailaddresses, name, phonenumbers)
VALUES (4, 'raypoul@hotmail.com', 'Raymond Poulidor', '87-66-18-90-12');

-- Merchant 5
insert into merchant 
(brandname, businessactivity, contractstatus, joindate, city, country, number, street, scoreenabled, scoreid, servicelevel, website) 
values 
('What else', 'CLOTHING', 'ENABLED', '2028-06-01', 'Paris', 'France', '5', 'Rivoli', true, 'ms-5', 'PREMIUM', 'http://www.whatelse.com/');
...
insert INTO merchant_contacts (merchant_id, emailaddresses, name, phonenumbers)
VALUES (5, 'gclou@gmail.com', 'Georges Clooney', '87-96-08-40-12');
